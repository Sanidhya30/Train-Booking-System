...
public class Train3 extends Train{
...
public Scanner sc = new Scanner(System.in);
	...
	public Train3() throws IOException
	{
		try {  
			
            Reader reader = new FileReader("D:/input_3.txt");  
	...
	public void coach()
	{
		...
		while(true)
		{
			...
			while(tem == 0)
			{
				try
				{
					System.out.println("Enter 1 to book a ticket in first tier : PRICE = Rs.2200");
					System.out.println("Enter 2 to book a ticket in second tier : PRICE = Rs.1700");
					System.out.println("Enter 3 to book a ticket in third tier : PRICE = Rs.1260");
					System.out.println("Enter 4 to book a ticket in sleeper coach : PRICE = Rs.500");
			...
			if(n > i)
			{
				...
				while(true)
				{
					...
					if(num == 1)
					{
						...
						{
							info();
							waiting_a2[k] = 3000 + tier + waiting_2;
							number[count] = 3000 + tier + waiting_2;
							k++;
							waiting++;
							count++;
							waiting_2++;
