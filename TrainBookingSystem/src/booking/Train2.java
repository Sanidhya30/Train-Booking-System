...
public Scanner sc = new Scanner(System.in);
	...
	public Train2() throws IOException
	{
		try {  
            ...
            Reader reader = new FileReader("D:/input_2.txt");  
	...
	public void coach()
	{
		...
		while(true)
		{
			...
			while(tem == 0)
			{
				try
				{
					System.out.println("Enter 1 to book a ticket in first tier : PRICE = Rs.1400");
					System.out.println("Enter 2 to book a ticket in second tier : PRICE = Rs.1250");
					System.out.println("Enter 3 to book a ticket in third tier : PRICE = Rs.970");
					System.out.println("Enter 4 to book a ticket in sleeper coach : PRICE = Rs.400");
			...
			if(n > i)
			{
				...
				while(true)
				{
					...
					if(num == 1)
					{
						...
						{
							info();
							waiting_a2[k] = 2000 + tier + waiting_2;
							number[count] = 2000 + tier + waiting_2;
							k++;
							waiting++;
							count++;
							waiting_2++;
